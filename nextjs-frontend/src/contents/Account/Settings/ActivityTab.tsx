...
function ActivityTab() {
  return (
    <Card>
      <CardHeader
        ...
        subheader={
          <>
            Managing Partner,{' '}
            <Link
              href="@/content/Account/Users/Settings/ActivityTab#"
              underline="hover"
            >
              #software
            </Link>
      ...
      >
        <Box>
          <Button startIcon={<ThumbUpAltOutlinedIcon />} variant="contained">
            Like
          </Button>
          <Button
          ...
          <Button startIcon={<ShareOutlinedIcon />} variant="outlined">
            Share
          </Button>
        </Box>
        <Box sx={{ mt: { xs: 2, md: 0 } }}>
